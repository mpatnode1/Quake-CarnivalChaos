...
const menu = {
    ...
    'Menu/Edit/Move objects': { path: ['Edit', 'Move...'], shortcut: { key: 'M', modifiers: ['Ctrl', 'Alt', ] } },
    ...
    'Controls/Map view/Deactivate current tool': { path: ['Edit', 'Tools', 'Deactivate Current Tool'], shortcut: { key: 'Esc', modifiers: ['Shift', ] } },
...
const actions = {
    'Controls/Map view/Deactivate current tool': { key: 'Esc', modifiers: ['Shift', ] },
    ...
    'Controls/Map view/Reset camera zoom': { key: 'Z', modifiers: ['Ctrl', 'Alt', ] },
